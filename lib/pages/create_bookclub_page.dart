...
class _CreateBookclubPageState extends State<CreateBookclubPage> {
  ...
  final List<String> maxMembersOptions = ["10명", "20명", "30명", "50명"]; // "직접 입력" 삭제
  final List<String> categoryOptions = [
    "인문학", "철학", "자기계발", "소설", "시/에세이", "경제/경영", "과학/기술", "예술/문화"
  ];

  Future<void> _createBookclub() async {
    if (_nameController.text.isEmpty || _bookTitleController.text.isEmpty || _descriptionController.text.isEmpty || _selectedCategory == null || _selectedAge == null || _selectedMaxMembers == null) {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text("북클럽이 성공적으로 생성되었습니다!")),
        );
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildOptionButtons(maxMembersOptions, _selectedMaxMembers, (value) {
              setState(() {
  ...
  Widget _buildOptionButtons(List<String> options, String? selectedValue, Function(String) onSelected) {
    return Wrap(
      spacing: 8,
